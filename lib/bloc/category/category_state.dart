...
class CategoryInitial extends CategoryState {
  CategoryInitial()
      : super(groups: [
          const CategoryGroup(id: 0, name: 'Bills', categories: [
          ...
          const CategoryGroup(id: 1, name: 'Frequent', categories: [
          ...
          const CategoryGroup(id: 2, name: 'Other', categories: [
          ...
          const CategoryGroup(id: 3, name: 'Givings', categories: [
          ...
          const CategoryGroup(id: 4, name: 'Goals', categories: [
          ...
          const CategoryGroup(id: 5, name: 'Debts', categories: [
